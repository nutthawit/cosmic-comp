...
use smithay::{
    ...
    input::{
        Seat,
        dnd::{DnDGrab, DndFocus, DndGrabHandler},
    ...
    wayland::{
        ...
        selection::data_device::{
            DataDeviceHandler, DataDeviceState, GrabType, WaylandDndGrabHandler,
        },
    },
};
use std::sync::Mutex;
...
impl WaylandDndGrabHandler for State {
    fn dnd_requested<S: smithay::input::dnd::Source>(
        ...
        type_: smithay::wayland::selection::data_device::GrabType,
    ) {
